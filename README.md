...
- Browse remote files and folders via SSH
- Fuzzy filter to quickly find items
...
| `d` | Queue selected file/folder for download |
...
1. **Browse**: Navigate through remote files and folders using SSH
2. **Filter**: Press `/` to fuzzy search file and folder names in real-time
3. **Download**: Press `d` to queue a file or folder for download using rsync
